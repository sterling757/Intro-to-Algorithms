...
void SortingAlgorithm::executeBubble(int i) {
...
void SortingAlgorithm::Stats(){
    ...
    for(int i = 0; i < statsStrings.size(); i++) {
        ...
        cout << string("Sort of Data Set of Size: " + to_string(statsStrings[i].first) + " = " + to_string(statsStrings[i].second) + " seconds") << endl;
